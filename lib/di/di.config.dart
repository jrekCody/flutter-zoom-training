...
import 'package:flutter_zoom/data/repository/auth_repository.dart' as _i8;
...
import 'package:flutter_zoom/data/repository/impl/user_repository_impl.dart'
    as _i11;
import 'package:flutter_zoom/data/repository/jitsi_repository.dart' as _i12;
import 'package:flutter_zoom/data/repository/user_repository.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt initDi({
    ...
    gh.singleton<_i8.AuthRepository>(
        () => _i9.AuthRepositoryImpl(gh<_i4.FirebaseAuth>()));
    gh.singleton<_i10.UserRepository>(
        () => _i11.UserRepositoryImpl(gh<_i5.FirebaseFirestore>()));
    gh.singleton<_i12.JitsiRepository>(
        () => _i13.JitsiRepositoryImpl(jitsiMeet: gh<_i6.JitsiMeet>()));
    ...
    gh.factory<_i15.JoinMeetingBloc>(() => _i15.JoinMeetingBloc(
          authRepository: gh<_i8.AuthRepository>(),
          jitsiRepository: gh<_i12.JitsiRepository>(),
        ));
